...
def generate_search_tests():
    return {
        'actions': {
            ...
            'bmo_sb_zone_clear_1': {
                'tags': ('zone', 'bmo_sb', 'mixed', 'remove', 'clear'),
                'params': {
                    'test': 'true',
                    'vehicle': 'BMO_SB'
                },
            ...
            'mixed_1': {
                'tags': ('naics', 'vehicle', 'pool', 'zone', 'setaside', 'mixed', 'bmo_sb'),
                'params': {
                    'naics': '561720', 
                    'vehicle': 'BMO_SB',
                    'pools': 'BMO_SB_5',
