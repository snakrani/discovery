...
class VendorTest(case.APITestCase, metaclass = case.MetaAPISchema):
    ...
    schema = {
            ...
            'fields': {
                ...
                'contract__id': {
                    'tags': ('vendor_field', 'contract_field', 'number'),
                    '@exact': 256,
                    '@lt': 500,
                    '@lte': 500, 
                    '@gt': 250, 
                ...
                'contract__piid': {
                    'tags': ('vendor_field', 'contract_field', 'fuzzy_text'),
                ...
                'contract__agency__id': {
                    'tags': ('vendor_field', 'contract_field', 'agency_field', 'token_text'),
                    '@exact': '8000',
                    '@iexact': '8000',
                    '@in': ('8000', '6800', '2050')
                },
                'contract__agency__name': {
                    'tags': ('vendor_field', 'contract_field', 'agency_field', 'fuzzy_text'),
                ...
                'contract__date_signed': {
                    'tags': ('vendor_field', 'contract_field', 'date_time'),
                    '@date': '2016-05-17',
                    '@year': '2007',
                    '@month': '7',
                    '@day': '9',
                ...
                'contract__status__code': {
                    'tags': ('vendor_field', 'contract_field', 'status_field', 'token_text'),
                    '@exact': 'C1',
                    '@iexact': 'c1',
                    '@in': ('A', 'C2', 'X', 'F')
                },
                'contract__status__name': {
                    'tags': ('vendor_field', 'contract_field', 'status_field', 'fuzzy_text'),
                    '@exact': 'Completed',
                    '@iexact': 'currEnt',
                ...
                'contract__pricing_type__code': {
                    'tags': ('vendor_field', 'contract_field', 'pricing_field', 'token_text'),
                    '@exact': 'Y',
                    '@iexact': 'u',
                    '@in': ('M', '3', 'K', 'Z')
                },
                'contract__pricing_type__name': {
                    'tags': ('vendor_field', 'contract_field', 'pricing_field', 'fuzzy_text'),
                ...
                'contract__place_of_performance__country_code': {
                    'tags': ('vendor_field', 'contract_field', 'placeofperformance_field', 'location_field', 'token_text'),
                    '@exact': 'USA',
                    '@iexact': 'usa',
                    '@in': ("USA","JPN","MDA","GBR")
                },
                'contract__place_of_performance__country_name': {
                    'tags': ('vendor_field', 'contract_field', 'placeofperformance_field', 'location_field', 'fuzzy_text'),
                    '@exact': 'United States',
                ...
                'contract__place_of_performance__zipcode': {
                    'tags': ('vendor_field', 'contract_field', 'placeofperformance_field', 'location_field', 'fuzzy_text'),
                    '@exact': '20190',
                    '@iexact': '20190',
                    '@in': ("20190", "93033", "22102"),
                ...
                'contract__vendor_location__address': {
                    'tags': ('vendor_field', 'contract_field', 'location_field', 'fuzzy_text'),
                    '@exact': '7000 Muirkirk Meadows Dr',
                    '@iexact': '7000 muirkirk meadows dr',
                    '@in': ("1002 Explorer Blvd", "8600 Boeing Dr"),
                    '@contains': 'South',
                ...
                'contract__vendor_location__city': {
                    'tags': ('vendor_field', 'contract_field', 'location_field', 'fuzzy_text'),
                    '@exact': 'Carlisle',
                    '@iexact': 'arlington',
                    '@in': ("Atlanta", "Reston", "Northville"),
                ...
                'contract__vendor_location__state': {
                    'tags': ('vendor_field', 'contract_field', 'location_field', 'token_text'),
                    '@exact': 'DC',
                    '@iexact': 'dc',
                    '@in': ("DC","CA","TX","VA")
                },
                'contract__vendor_location__zipcode': {
                    'tags': ('vendor_field', 'contract_field', 'location_field', 'fuzzy_text'),
                    '@exact': '20190',
                    '@iexact': '20190',
                    '@in': ("20190", "93033", "22102"),
                ...
                'contract__vendor_location__congressional_district': {
                    'tags': ('vendor_field', 'contract_field', 'location_field', 'token_text'),
                    '@exact': '07',
                    '@iexact': '07',
                    '@in': ("07", "04", "08", "01")
