...
class ContractFilter(FilterSet):
    ...
    date_signed__year = NumberFilter(field_name='date_signed', lookup_expr='year')
    date_signed__month = NumberFilter(field_name='date_signed', lookup_expr='month')
    date_signed__day = NumberFilter(field_name='date_signed', lookup_expr='day')
    date_signed__week = NumberFilter(field_name='date_signed', lookup_expr='week')
    date_signed__week_day = NumberFilter(field_name='date_signed', lookup_expr='week_day')
    date_signed__quarter = NumberFilter(field_name='date_signed', lookup_expr='quarter')
    
    completion_date = CharFilter(field_name="completion_date", lookup_expr="startswith")
    completion_date__year = NumberFilter(field_name='completion_date', lookup_expr='year')
    completion_date__month = NumberFilter(field_name='completion_date', lookup_expr='month')
    completion_date__day = NumberFilter(field_name='completion_date', lookup_expr='day')
    completion_date__week = NumberFilter(field_name='completion_date', lookup_expr='week')
    completion_date__week_day = NumberFilter(field_name='completion_date', lookup_expr='week_day')
    completion_date__quarter = NumberFilter(field_name='completion_date', lookup_expr='quarter')
